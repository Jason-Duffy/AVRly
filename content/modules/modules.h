 ...
 * @brief A guide for setting up your development environment.
 * @details This module contains the documentation for the files referenced in
 * Getting Started with Blink.
 */

/**
 * @defgroup anatomy Anatomy of Embedded Firmware
 * @brief Guidelines for layout and style.
 * @details This module contains the documentation for the files referenced in
 ...
 * @brief A collection of drivers and example applications for Data Converters.
